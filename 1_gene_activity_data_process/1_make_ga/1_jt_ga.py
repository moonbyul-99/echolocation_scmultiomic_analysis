...
# 配置日志记录器
logging.basicConfig(filename='jt_process.log', level=logging.INFO, 
                    format='%(asctime)s - %(levelname)s - %(message)s')

path_dic = {
    'bq':'/home/rsun@ZHANGroup.local/sly_data/data/JT/JTBQ/atac_fragments.tsv.gz',
    'ct':'/home/rsun@ZHANGroup.local/sly_data/data/JT/JTCT/atac_fragments.tsv.gz',
    'hm':'/home/rsun@ZHANGroup.local/sly_data/data/JT/JTHM/atac_fragments.tsv.gz',
    'ng':'/home/rsun@ZHANGroup.local/sly_data/data/JT/JTNG/atac_fragments.tsv.gz',
    'qn':'/home/rsun@ZHANGroup.local/sly_data/data/JT/JTQN/atac_fragments.tsv.gz',
    'pc':'/home/rsun@ZHANGroup.local/sly_data/data/JT/JTPC/atac_fragments.tsv.gz',
    'xq':'/home/rsun@ZHANGroup.local/sly_data/data/JT/JTXQ/atac_fragments.tsv.gz',
    'yb':'/home/rsun@ZHANGroup.local/sly_data/data/JT/JTYB/atac_fragments.tsv.gz'
    }
...
if __name__ == '__main__': 
    ...
    chrom_dic_path = '/home/rsun@ZHANGroup.local/sly_data/genome/10x_genome/rsi/star/chrNameLength.txt'
